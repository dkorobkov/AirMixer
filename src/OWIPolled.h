...
*/
#define     _OWI_DELAY_A_STD_MODE   6
#define     _OWI_DELAY_B_STD_MODE   64
#define     _OWI_DELAY_C_STD_MODE   60
#define     _OWI_DELAY_D_STD_MODE   10
#define     _OWI_DELAY_E_STD_MODE   9
#define     _OWI_DELAY_F_STD_MODE   55
#define     _OWI_DELAY_H_STD_MODE   480
#define     _OWI_DELAY_I_STD_MODE   70
#define     _OWI_DELAY_J_STD_MODE   410
